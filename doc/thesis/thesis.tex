...
% Title
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Taming Aspects with Managed Data In Java}
...
\abstract{
	...
	Our work focuses on the implementation of managed data in Java, presenting how managed data can be implemented in a static language.
