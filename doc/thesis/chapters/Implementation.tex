...
This interface defines a single method \texttt{schemaKlass}, which refers to the \texttt{Klass} that an object is described with.
...
This list is responsible of keeping interfaces that are going to be added to the proxy instance creation.
This way an instance of a proxy can be ``casted'' to any of these interfaces, in this case the managed object can be casted to \texttt{Lockable}.
