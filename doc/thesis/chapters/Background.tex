...
\begin{figure}[H]
	\centering
  	\fbox{\includegraphics[width=.65\textwidth]{figures/BG_Observer_pattern_Selection_Listener.png}}
...
\begin{figure}[H]
	\centering
  	\fbox{\includegraphics[width=.65\textwidth]{figures/BG_The_concern_types_in_Selection_Listener.png}}
