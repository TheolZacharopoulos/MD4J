...
% In Chapter \ref{Theory} the theory is presented, which is going to be used as a reference for our implementation.
In Chapter \ref{Implementation} the implementation is discussed, providing explanation of our issues 
and implementation details.
Next, in Chapter \ref{Evaluation} an evaluation of our implementation is illustrated, by applying it in JHotDraw. 
