...
In this thesis we show how we use managed data in order to tame aspects and compare our findings with the original JHotDraw and an AspectJ show case, the AJHotDraw.
