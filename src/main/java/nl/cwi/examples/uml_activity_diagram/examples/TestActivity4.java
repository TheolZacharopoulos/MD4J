...
//        exp_0.assignee(var3_0);
//        exp_0.operator(IntegerCalculationOperator.ADD);
//        exp_0.operand1(var3_0);
//        exp_0.operand2(var4_1);
//
//        IntegerCalculationExpression exp_0 = f.IntegerCalculationExpression();
//        exp_0.assignee(var3_0);
//        exp_0.operator(IntegerCalculationOperator.ADD);
//        exp_0.operand1(var3_0);
//        exp_0.operand2(var5_2);
//
//        BooleanBinaryExpression exp_0 = f.BooleanBinaryExpression();
//        exp_0.assignee(var8_5);
//        exp_0.operator(BooleanBinaryOperator.OR);
//        exp_0.operand1(var6_3);
//        exp_0.operand2(var7_4);
//
//        BooleanUnaryExpression exp_0 = f.BooleanUnaryExpression();
//        exp_0.assignee(var7_4);
//        exp_0.operator(BooleanUnaryOperator.NOT);
//        exp_0.operand(var6_3);
//
//        IntegerComparisonExpression exp_0 = f.IntegerComparisonExpression();
//        exp_0.assignee(var6_3);
//        exp_0.operator(IntegerComparisonOperator.SMALLER);
//        exp_0.operand1(var4_1);
//        exp_0.operand2(var5_2);
//
//        action6_7.outgoing(edge16_13);
//        action6_7.incoming(edge15_12);
//
//        action6_7.expressions(exp_1, exp_2);
//
