...
public class MObjectUtils2 {
    private static final org.apache.log4j.Logger logger = LogManager.getLogger(MObjectUtils2.class.getName());
    ...
    public static boolean e(Map<Object, Object> equalityMap, Map<Object, List<Object>> crossReferences, Object x, Object y) {
        ...
        logger.debug(" <<Object>> (x) : " + yKlass.name());
